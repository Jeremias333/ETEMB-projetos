...
public class InternTelaResumoADC extends JInternalFrame {
	...
	public static void inicio() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				try {
					InternTelaResumoADC frame = new InternTelaResumoADC();
